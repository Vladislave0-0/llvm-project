#include "MCTargetDesc/RussiaInstPrinter.h"
#include "Russia.h"
...
class RussiaAsmPrinter : public AsmPrinter {
...
#include "RussiaGenMCPseudoLowering.inc"

void RussiaAsmPrinter::emitInstruction(const MachineInstr *MI) {
  RUSSIA_DUMP_GREEN
...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeRussiaAsmPrinter() {
  RegisterAsmPrinter<RussiaAsmPrinter> X(getTheRussiaTarget());
}
