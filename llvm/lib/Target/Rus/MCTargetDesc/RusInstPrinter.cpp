...
#include "RusGenAsmWriter.inc"

void RusInstPrinter::printRegName(raw_ostream &O, MCRegister Reg) {
...
void RusInstPrinter::printBranchOperand(const MCInst *MI, uint64_t Address,
